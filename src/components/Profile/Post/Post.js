        ...
        <div className={x.post}>
            ...
            <div className="d-flex justify-content-between">
                <div className="d-flex">
                    <Ava statusColor="#06d6a0"
                         image="http://chatvia-dark.react.themesbrand.com/static/media/avatar-2.feb0f89d.jpg"/>
                    <div>
                        <div className={x.postAuthor}>Taras Shevchenko</div>
                        <div className={x.postDate}>
                ...
                <div className="d-flex">
                    ...
                    <div className={`${x.postDislike} ${x.postButton}`}>
                        <svg width="16" height="16" aria-hidden="true" focusable="false" data-prefix="far"
                             data-icon="thumbs-up"
                             className="svg-inline--fa fa-thumbs-up fa-w-16" role="img"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div className={x.postContent}>
                <div className={x.postContentText}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non,
                    feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus.Lorem ipsum
                    dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non,
                    feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus.Lorem ipsum
                    dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non,
                    feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus.Lorem ipsum
                    dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non,
                ...
                <div className={x.postContentImage}>
                    <img src="http://sociala.uitheme.net/assets/images/t-10.jpg" alt="postContentImage"/>
                </div>
